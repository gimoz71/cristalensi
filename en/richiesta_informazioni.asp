...
if mode=1 then
	if email<>"" then
		...
		Destinatario = email
		Mittente = "info@cristalensi.it"
		Oggetto = "Request for an estimate for articles code number: "&codice
		Testo = HTML1
...
<body>
	<div>
		...
		<%else%>	
		<p>To request an estimate for the products please fill out the following form our staff will be pleased to answer any questions. <br />
		  <br />
	      <br />Product for which you are asking a quote:<br />
	      Name: <b><%=titolo%></b> - Code: <b><%=Codice%></b> - Producer: <b><%=Produttore%></b></p>
		<table width="100%" border="0" cellpadding="5" cellspacing="0">
		<form method="post" name="modulo" action="richiesta_informazioni.asp" onSubmit="return control();">
