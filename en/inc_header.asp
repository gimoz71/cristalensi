<header id="header">
    ...
    <div id="menu">
        <ul>
            <li class="green"><a href="index.asp" title="Cristalensi Home Page lights online store">home page</a></li>
            <li class="darkorange"><a href="chi_siamo.asp" title="Our showroom of lamps and lights">who we are</a></li>
            <li class="skyblue"><a href="contatti.asp" title="Contacts">contacts</a></li>
