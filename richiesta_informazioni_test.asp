...
if mode=1 then
	if email<>"" then
		...
		Destinatario = "info@viadeimedici.it"
		Mittente = "info@viadeimedici.it"
...
<body>
	<div>
		...
		<%else%>	
		<p>Per richiedere un preventivo di prezzo del prodotto <b>riempi il seguente modulo</b>, <br />oppure <b>contattaci direttamente</b>, il nostro staff sar&agrave; a Tua disposizione per qualsiasi chiarimento. <br /><img src="immagini/numeroverde_orizzontale_cristalensi.gif" width="330" height="85" hspace="5" vspace="10" align="middle">
		  <br />
	      <br />Prodotto di cui stai chiedendo il preventivo:<br />Nome: <b><%=titolo%></b> - Codice: <b><%=Codice%></b> - Produttore: <b><%=Produttore%></b></p>
		<table width="100%" border="0" cellpadding="5" cellspacing="0">
		<form method="post" name="modulo" action="richiesta_informazioni_test.asp" onSubmit="return control();">
