...
//          })();
        ...
        <div id="wrap">
            ...
            <div id="main-content">
                <div id="content-sidebar-wrap" >
                    <div id="content">
                        <div>
                            <h3 style="font-size: 14px; display: inline; border:none;">Condizioni di vendita</h3>
                            ...
                            Per inserire un prodotto nel carrello, dovete accedere alla scheda del prodotto.<br />
                            Una volta inserita la quantit&agrave; di pezzi desiderati, selezionate l'immagine del carrello, automaticamente il prodotto scelto verr&aacute; aggiunto nel vostro carrello virtuale.
    Potrete in qualsiasi momento accedere al carrello cliccando sulla voce &quot;carrello&quot; dal men&ugrave; in alto.<br />
    In ogni momento potete eliminare un articolo o modificarne la quantit&agrave;: la pagina calcoler&agrave; il totale in tempo reale.
                            </p>
                            <p>
                            ...
                            avete a disposizione molti sistemi per pagare l'ordine (bonifico, bancario, carte di credito, carte prepagate e PostePay), anche i diffusi e sicurissimi sistemi di Paypal. <br />
                            In questa pagina avete la possibilit&agrave; di specificare alcuni dati per la fatturazione: i dati per la fattura/scontrino fiscale potranno cos&igrave; essere diversi da quelli della registrazione. <br />
                            <em>Arrivati alla pagina di conferma d'ordine vi verr&aacute; inviata un'email riassuntiva dell'Ordine inviato.<br />
                            <br />
                            La merce verr&agrave; spedita non appena la banca certificher&agrave; contabilmente il pagamento. <br />
                            In seguito verrete contattati, via email o telefono, dal nostro staff che vi indicher&agrave; la data di invio della merce, il nome del corriere e il relativo codice di spedizione per rintracciare eventualmente la merce spedita. </em>
                            </p>
                            <p>
                            <span class="sfondo-giallo"><strong>
                            Disponibilit&agrave; prodotti:</strong></span> <br />
                            Il nostro catalogo &egrave; composto da numerosi prodotti e numerose ditte, a tal ragione alcuni prodotti, al momento della richiesta, potrebbero non essere dispobili immediatamente e potrebbero essere in fase di ordinazione. Nel caso in cui ci fosse urgenza del prodotto desiderato, <strong>informarsi direttamente dal nostro staff per l'effettiva disponibilit&agrave; o tempo di consegna</strong> nel caso in cui non fosse disponibile.<br />
                            La consegna potr&agrave; avvenire tra un minimo di 2 giorni ed un massimo di 30 giorni.
                            </p>
                            <p>
                            ...
                            <br />
                            La documentazione fiscale, mediante carta di accompagnamento fisicamente acclusa al pacco o inviata via mail, relativa ai Prodotti ordinati verr&agrave; emessa da Cristalensi al momento della spedizione dei prodotti stessi al Cliente.
                            </p>
                            <p>
                            <span class="sfondo-giallo"><strong>
                            Condizioni di recesso:</strong></span> <br />
                            Le vendite di prodotti via Internet sono disciplinate dal <strong>D.lgs n. 206/05 (CODICE DEL CONSUMO)</strong> che regola la materia dei contratti a distanza, da intendersi per tali le vendite effettuate al di fuori dei locali commerciali.<br />
                            Tale normativa, in vigore dal 23 Ottobre 2005, sancisce il diritto di recesso, ovvero la possibilit&agrave; per il consumatore di restituire il prodotto acquistato e di ottenere il rimborso della spesa sostenuta<br />
    						Questo diritto &egrave; riservato esclusivamente alle persone fisiche (consumatori), quindi non pu&ograve; essere esercitato dalle persone giuridiche e dalle persone fisiche che agiscono per scopi riferibili all'attivit&agrave; professionale eventualmente svolta. Tale diritto non spetter&agrave; pertanto a coloro che hanno fornito, ai fini della fatturazione, la propria Partita IVA.
    						<br />
                            <br />
                            Per esercitare il <strong>diritto di recesso</strong> &egrave; necessario inviare, <strong>entro 10 giorni lavorativi dal ricevimento della merce</strong>, una comunicazione nella quale viene chiaramente manifestata la volont&agrave; di recedere dal contratto (&egrave; necessario inviare una raccomandata con ricevuta di ritorno).<br />
                            Le spese di restituzione del prodotto sono a carico del consumatore (D.lgs n. 206/05 - artt. da 50 a 68).
    <br />
                            <br />
                            Il diritto del recesso non si applica per prodotti espressamente eseguiti su specifica o disegno del cliente nonch&eacute; su prodotti che vengono modificati o assemblati con altri su richiesta del cliente. 
    
                            <br />
                            <strong><br />
                            Decadenza del diritto di recesso.<br />
                            </strong>Il diritto di recesso decade totalmente qualora il prodotto restituito non sia integro, ovvero:<br />
    ...
    <br />
                            <br />
                            <strong> Procedura per l'esercizio del diritto di recesso.<br />
                            </strong>Nel caso in cui abbia acquistato a distanza (on-line, fax, e-mail) presso il nostro negozio, e voglia recedere dall'acquisto, dovr&agrave; seguire questa semplice procedura:<br />
                            Inviare a Cristalensi , entro 10 giorni lavorativi dal ricevimento della merce, con lettera raccomandata con avviso di ricevimento, una comunicazione con le cause del recesso.<br />
                            Anticipare la comunicazione via e-mail all'indirizzo: info@cristalensi.it.<br />
                            ...
                            <br />
                            <br /> 
                            <span class="sfondo-giallo"><strong>Rotture derivanti dal trasporto</strong></span><br /><strong>
                            Al momento del ricevimento, firmare e mettere la dicitura &quot;RISERVA DI CONTROLLO&quot; sia sulle 2 BOLLE che sulla CEDOLINA del corriere</strong>, tutto ci&ograve; &egrave; utile per avere maggiori garanzie nel caso in cui siano presenti prodotti danneggiati.<br />
                            Dopo la consegna verificare la presenza e l'integrit&agrave; di tutte le lampade oggetto dell'ordine.<br />
                            Eventuali comunicazioni di anomalie o rotture devono essere comunicate a mezzo mail unitamente a fotografie del danno riscontrato <strong>entro e non oltre 8 giorni dal ricevimento della merce</strong>.<br />
