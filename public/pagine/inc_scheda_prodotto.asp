                            ...
                            <ul class="scheda-prodotto clearfix">
                                <li class="clearfix">
                                    ...
                                    <h1><%=Titolo_prodotto%> - <%=codicearticolo%></h1>
                                        <p class="area clearfix"><%if codicearticolo<>"" then%>Codice articolo <strong>[<%=codicearticolo%>]</strong><%end if%><%if fkproduttore>0 then%><small class="produttore">produttore: <a href="/prodotti.asp?FkProduttore=<%=fkproduttore%>" title="Elenco prodotti dello stesso produttore: <%=produttore%>"><strong><%=produttore%></strong></a></small><%end if%></p>
                                    <div class="data">
