			<div id="sidebar-alt" >
                    <div>
                        ...
                        <%else%>
                            ...
                            <%if contr=2 then%>
                            <font color="#990000"><strong>Attenzione! I dati inseriti<br />non sono corretti.</strong></font>
                            <%end if%>
                        ...
                        <img src="/images/telefono_cristalensi.gif" align="absmiddle" style="padding:10px 0 20px 0;" alt="Numero per chiamare lo staff del negozio Cristalensi, orario negozio dal Lunedi al Sabato: 0571.911163" />
                    </div>
                </div>
