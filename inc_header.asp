<header id="header">
    <div id="language">
        <ul>
        <li><a href="javascript:void(0)" title="Cristalensi vendita lampadari on line"><img class="flag" src="/images/flag_it.png" alt="Cristalensi vendita lampadari on line"></a></li>
    ...
    <div id="menu">
        <ul>
            <li class="green"><a href="http://www.cristalensi.it" title="Cristalensi vendita lampadari on line">home page</a></li>
