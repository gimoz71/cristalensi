...
Call Visualizzazione("",0,"carrello1.asp")
	...
	'se la session √® gi√† aperta sfrutto il pkid dell'ordine, altrimenti ne apro una
	...
	'inserimento di un prodotto per la prima volta scelto con il carrello gi√† aperto
                ...
                <div id="content-sidebar-wrap" >
                    <div id="content">
                        <div>
                            ...
                            <div class="carrello clearfix">
                                ...
                                <%if ss.recordcount>0 then%>
                                  ...
                                  &#8364;
									...
									<%if rs.recordcount>0 then%>
                                    <form method="post" action="<%if italia_log="Si" or italia_log="" then%>/carrello2.asp<%end if%><%if italia_log="No" then%>/carrello2extra.asp<%end if%>">
                            ...
                            <tr class="bordo-top"><td width="80%"><strong>&raquo; Ordine maggiore di 250Ä:</strong></td><td width="20%" align="right"><strong>0Ä</strong></td></tr>
                            <tr class="bordo-top"><td width="80%">&raquo; Ordine minore di 250Ä:</td><td width="20%" align="right">10Ä</td></tr>
                            <tr class="bordo-top"><td width="80%">&raquo;  Ritiro in sede:</td><td width="20%" align="right">0Ä</td></tr>
                            ...
                            <table cellpadding="3" cellspacing="3" width="100%" border="0">
                            <tr class="bordo-top"><td width="80%">&raquo; Bonifico bancario:</td><td width="20%" align="right">0Ä</td></tr>
                            <tr class="bordo-top"><td width="80%">&raquo; Poste Pay:</td><td width="20%" align="right">0Ä</td></tr>
                            <tr class="bordo-top"><td width="80%">&raquo; Contassegno:</td><td width="20%" align="right">4Ä</td></tr>
