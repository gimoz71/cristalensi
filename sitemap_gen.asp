...
session("server")="http://www.cristalensi.it"
vDir = "/"
...
Function Folderpermission(pathName)
	...
	PathExclusion=Array("\temp","\_vti_cnf","\_vti_pvt","\_vti_log","\cgi-bin","\admin","\js","\mdb-database")
...
Function FileNameIsBad(sFileName)
        ...
        Filename = Array("/alive.asp","/404.asp","/500.asp","/sitemap_gen.asp","/aspcaptcha.asp","/calcolospedizione.asp","/carrello2.asp","/carrello2extra.asp","/carrello3.asp","/clsImageSize.asp","/foto.asp","/index2.asp","/ordine.asp","/ordini_elenco.asp","/pagamento_paypal_ko.asp","/pagamento_paypal_ok.asp","/piede.asp","/stampa_ordine.asp","/stile.css","/stile_stampa.css","/strClose.asp","/strClose.asp","/testata_logo.asp","/testata_menu.asp")
