...
'========================================================='
	...
	Public Sub Save(MyPath)
		Dim objFSO, objFSOFile
		Dim lngLoop
		Set objFSO = Server.CreateObject("Scripting.FileSystemObject")
		'path = "../public/"&m_strFileName'
		'Set objFSOFile = objFSO.CreateTextFile( Server.MapPath(path) )'
		path = "d:\inetpub\webs\cristalensiit\public\"&m_strFileName
