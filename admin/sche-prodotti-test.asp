  ...
  <tr>
    ...
    Il sistema si aggiorner&agrave; da solo entro pochi secondi.</p>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="admin-righe">
				  ...
				  <textarea class="ckeditor" cols="80" id="editor1" name="editor1" rows="10"><%=testo%></textarea>
				  </td></tr>
                   <tr align="left">
                    <td height="20" colspan="2">&nbsp;</td>
                  </tr>
                  ...
                  <tr><td colspan="2" align="center">
				  <textarea class="ckeditor" cols="80" id="editor2" name="editor2" rows="10"><%=testo_en%></textarea>
                  </td></tr>
                   <tr align="left">
                    <td height="20" colspan="2">&nbsp;</td>
                  </tr>
