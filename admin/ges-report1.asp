...
if ordine="" then ordine=3

if ordine=1 then ord="Titolo ASC"
if ordine=2 then ord="Titolo DESC"
if ordine=3 then ord="Visualizzazioni ASC"
if ordine=4 then ord="Visualizzazioni DESC"
			
Set nrs=Server.CreateObject("ADODB.Recordset")
sql = "SELECT PkId, Titolo, CodiceArticolo, Visualizzazioni "
          ...
          <!--tab centrale-->
			<table width="98%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr class="admin-intestazione" align="left"> 
                <td width="59%">&nbsp;Titolo&nbsp;(Codice)&nbsp;<a href="ges-report1.asp?ordine=1&tipo=<%=tipo%>">A/Z</a>&nbsp;<a href="ges-report1.asp?ordine=2&tipo=<%=tipo%>">Z/A</a></td>
                <td colspan="2">Totale&nbsp;<a href="ges-report1.asp?ordine=3&tipo=<%=tipo%>">0/1</a>&nbsp;<a href="ges-report1.asp?ordine=4&tipo=<%=tipo%>">1/0</a></td>
              </tr>
              <tr> 
                <td colspan="3">&nbsp;</td>
              </tr>
              ...
              <tr align="left" class="admin-righe" <% if t = 1 then %>bgcolor="#CFCFCF"<% end if %>> 
                <td height="25">&nbsp;<%=nrs("Titolo")%> (<%=nrs("CodiceArticolo")%>)</td>
                <td width="21%" height="25"><%=visualizzazioni%></td>
                <td width="20%"><a href="sche-prodotti.asp?pkid=<%=nrs("pkid")%>" target="_blank">Apri scheda</a></td>
              </tr>
              ...
              <%else%>
              <tr> 
                <td colspan="3">Nessuna visualizzazione presente</td>
              </tr>
              <%end if%>
              <tr> 
                <td colspan="3">&nbsp;</td>
