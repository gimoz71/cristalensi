  ...
  <tr>
    <td height="30" colspan="2" valign="middle"><table width="750" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="267" class="menu-celle">Gestione Costi Pagamento</td>
          ...
          <!--tab centrale-->
			<table width="98%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr class="admin-intestazione" align="left"> 
                <td>&nbsp;<a href="ges-pagamenti.asp?ordine=0">Cod.</a>&nbsp;Costo&nbsp;<a href="ges-pagamenti.asp?ordine=1">A/Z</a>&nbsp;<a href="ges-pagamenti.asp?ordine=2">Z/A</a></td>
              ...
              <tr align="left" class="admin-righe" <% if t = 1 then %>bgcolor="#CFCFCF"<% end if %>> 
                <td>&nbsp;<a href="sche-pagamenti.asp?pkid=<%=nrs("pkid")%>&ordine=<%=ordine%>"><font color="#CC0000"><%=nrs("pkid")%>.</font><%=nrs("nome")%></a></td>
                <td align="center"><a href="sche-pagamenti.asp?mode=1&pkid=<%=nrs("pkid")%>&C1=ON&ordine=<%=ordine%>&p=<%=p%>"><font color="#CC0000">X</font></a></td>
               </tr>
