  ...
  <tr>
    ...
    Il sistema si aggiorner&agrave; da solo entro pochi secondi.</p>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="admin-righe">
				  ...
				  <tr align="left">
                    <td width="328"><strong>Dove viene visualizzato il prodotto</strong></td>
                    <td width="259"><strong>In primo piano</strong></td>
                  </tr>
				  <tr align="left">
                    <td width="328">Solo nei prodotti 
...
%>
					...
					editor.editor "testo", initialValue
					%>
                  </td></tr>
                   <tr align="left">
                    <td height="20" colspan="2">&nbsp;</td>
...
%>
                  ...
                  <%
					...
					' Create textarea element and attach CKEditor to it.
					editor.editor "testo_en", initialValue
					%>
                  </td></tr>
                   <tr align="left">
                    <td height="20" colspan="2">&nbsp;</td>
				  ...
				  <%if pkid>0 then%>
					  <tr> 
                        <td colspan="2"><iframe width="548" height="280" src="ins_file.asp?id=<%=pkid%>&tab=Prodotti"></iframe></td>
                      </tr>
					<%else%>
					  <tr> 
