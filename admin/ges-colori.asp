  ...
  <tr>
    <td height="30" colspan="2" valign="middle"><table width="750" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="267" class="menu-celle">Gestione Colori</td>
          <td width="324" class="menu-celle" align="right"><a href="ges-colori.asp">Elenco Colori&raquo;</a>&nbsp;&nbsp;<a href="sche-colori.asp">Nuovo colore &raquo;</a></td>
        </tr>
      </table></td>
  </tr>
  <tr>
          ...
          <!--tab centrale-->
			<table width="98%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr class="admin-intestazione" align="left"> 
                <td>&nbsp;<a href="ges-colori.asp?ordine=0">Cod.</a>&nbsp;Colore&nbsp;<a href="ges-colori.asp?ordine=1">A/Z</a>&nbsp;<a href="ges-colori.asp?ordine=2">Z/A</a></td>
              ...
              <tr align="left" class="admin-righe" <% if t = 1 then %>bgcolor="#CFCFCF"<% end if %>> 
                <td>&nbsp;<a href="sche-colori.asp?pkid=<%=nrs("pkid")%>&ordine=<%=ordine%>"><font color="#CC0000"><%=nrs("pkid")%>.</font><%=nrs("titolo")%></a></td>
                <td align="center"><a href="sche-colori.asp?mode=1&pkid=<%=nrs("pkid")%>&C1=ON&ordine=<%=ordine%>&p=<%=p%>"><font color="#CC0000">X</font></a></td>
               </tr>
              ...
              <%else%>
              <tr> 
                <td colspan="2">Nessun colore presente</td>
              </tr>
              <%end if%>
              <tr> 
                <td colspan="2">&nbsp;</td>
              ...
              <tr class="admin-intestazione" align="left"> 
                <td colspan="2">&nbsp; <% if nrs.recordcount > 0 then %>
                  ...
                  [<a href="ges-colori.asp?p=<%=p-5%>&ordine=<%=ordine%>">&lt;&lt; 
                  5 prec</a>] 
                  <% end if %> <% if p > 1 then %>
                  [<a href="ges-colori.asp?p=<%=p-1%>&ordine=<%=ordine%>">&lt; 
                  prec</a>] 
                  <% end if %> <% for page = p to p+4 %> <a href="ges-colori.asp?p=<%=Page%>&ordine=<%=ordine%>" class="testo"><%=page%></a> <% if page = nrs.PageCount then
		   		 		page = p+4
   		 				end if
	    				%> <% next %> <% if page-1 < nrs.PageCount then %>
                  [<a href="ges-colori.asp?p=<%=p+1%>&ordine=<%=ordine%>">succ 
                  &gt;</a>] 
                  <% end if %> <% if nrs.PageCount-page > 5 then %>
                  [<a href="ges-colori.asp?p=<%=p+5%>&ordine=<%=ordine%>">5 
                  succ &gt;&gt;</a>] 
                  <% end if%> &nbsp; &nbsp;[<a href="ges-colori.asp?p=<%=nrs.PageCount%>&ordine=<%=ordine%>">ultima 
                  pagina</a>] <% end if %> </td>
              </tr>
              <tr> 
                <td colspan="2">&nbsp;</td>
