...
<%
	...
	if pkid > 0 then sql = "Select * From CostiPagamento where pkid="&pkid
    ...
    Il sistema si aggiorner&agrave; da solo entro pochi secondi.</p>
                <SCRIPT LANGUAGE="JavaScript">
							<!--
			   					...
			   					function update(){
			        			document.location.href = "ges-pagamenti.asp?ordine=<%=ordine%>";
			   					}
							//-->
							</script>
                <% else %>
    ...
    Il sistema si aggiorner&agrave; da solo entro pochi secondi.</p>
                <SCRIPT LANGUAGE="JavaScript">
								<!--
			   					setTimeout("update()",2000);
			   					function update(){
			        			document.location.href = "ges-pagamenti.asp?p=<%=p%>&ordine=<%=ordine%>";
			   					}
								//-->
								</script>
                <% else %>
				<table cellpadding="0" cellspacing="0" border="0" width="95%" class="admin-righe">
				  <tr> 
					...
					<form method="post" action="sche-pagamenti.asp?mode=1&pkid=<%=pkid%>&p=<%=p%>&ordine=<%=ordine%>" name="newsform">
                  <tr align="left">
